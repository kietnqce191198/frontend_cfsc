    ...
    useEffect(() => {
        const fetchOrders = async () => {
            ...
            if (!customerId || customerId === "null") {
                console.error("Customer ID was not found for the current user.");
                setError("Customer information was not found. Please sign in again.");
                setLoading(false);
                return;
            }
            ...
            try {
                ...
                // Assume the backend returns an object whose data field contains the orders array.
                                ...
                                {loading ? (
                                    ...
                                    orders.map((order) => (
                                        ...
                                        >
                                            ...
                                            <div style={{ flex: 1 }}>{order.itemsCount} items</div>
