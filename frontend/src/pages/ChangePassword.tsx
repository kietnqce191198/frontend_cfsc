...
const ChangePassword: React.FC = () => {
    ...
    const isAdminAccount = canAccessAdminWorkspace(storedProfile);
    const homeRoute = isAdminAccount ? '/admin' : '/';
        ...
        <div className="account-page">
            <header className="header active">
                <div className="container d-flex align-items-center w-100">
                    <Link to={homeRoute} className="logo"><i className="fas fa-mug-hot"></i> coffee</Link>
                        ...
                        <div className="account-card-body">
                            <form className="account-form" onSubmit={handleSubmit} noValidate>
                                ...
                                <div className="account-action-row d-flex justify-content-center">
                                    <Link to={homeRoute} className="link-btn account-secondary-btn">
                                        <i className="fas fa-house"></i> <span>{isAdminAccount ? 'Command Center' : 'Storefront'}</span>
                                    </Link>
